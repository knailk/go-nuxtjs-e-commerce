        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1" v-for="item in listProducts.products" :key="item.id">
                        <div style="height: 100%;" class="card product-item border-0 mb-4">
                            <div style="height: 65%" class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            ...
                            <div div style="height: 15%" class="card-footer d-flex justify-content-between bg-light border">
                                <NuxtLink NuxtLink :to="'/categories/'+ item.category + '/' + item.id" class="btn btn-sm text-dark p-0"><i
