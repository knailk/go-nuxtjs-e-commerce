      ...
      <div class="row px-xl-5">
        <div class="col-lg-5 pb-5">
          <div id="product-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner border">
              <div class="carousel-item active" style="max-height:475px;width:80%">
                <img class="w-100 h-100" :src="require(`~/assets/img/${productDetail.image}`)" alt="Image"
                  style="margin-right: auto;margin-left: auto;">
              </div>
              <div class="carousel-item" style="max-height:475px;width:80%">
                <img class="w-100 h-100" :src="require(`~/assets/img/${productDetail.image}`)" alt="Image"
                  style="margin-right: auto;margin-left: auto;">
              </div>
              <div class="carousel-item" style="max-height:475px;width:80%">
        ...
        <div class="col-lg-7 pb-5">
          ...
          <div class="d-flex mb-3">
            ...
            <small class="pt-1">({{ productDetail.quantitySold }} Sold)</small>
          </div>
          ...
          <div class="d-flex align-items-center mb-4 pt-2">
            <div class="input-group quantity mr-3" style="width: 130px;">
              <div class="input-group-btn">
                <button @click='decrement' class="btn btn-primary btn-minus">
                  <i class="fa fa-minus"></i>
                </button>
              </div>
              <input type="text" class="form-control bg-secondary text-center" v-bind:value="counter">
              <div class="input-group-btn">
                <button @click='increment' class="btn btn-primary btn-plus">
                  <i class="fa fa-plus"></i>
                </button>
              </div>
            </div>
            <button class="btn btn-primary px-3" @click="addToCart(productDetail.id)"><i
