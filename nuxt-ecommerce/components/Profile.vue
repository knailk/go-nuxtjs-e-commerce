      ...
      <div class="container" style="margin-top:120px">
        <div class="main-body">
          ...
          <div class="row gutters-sm">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted font-size-sm">HCM City, Viet Nam</p>
                      <button class="btn btn-primary">Message</button>
                      <button class="btn btn-outline-primary" @click="$auth.logout()">Logout</button>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-primary">Link your website</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <span class="text-primary">knailk</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="col-md-8">
              <div v-if="viewProfile" class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-3">
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                      <button class="btn btn-info" @click="editProfile">Edit</button>
                    </div>
                    <div class="col-sm-3">
              ...
              <div v-else class="card">
                <div class="card-body">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-primary">
                      <input type="text" class="form-control" v-model="form.phone" minlength="9" maxlength="11">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 d-md-flex" style="color:#495057">
                      <input id="male" type="radio" name="gender" class=" form-control text-left" value="Male"
                        style="width: 5% !important;" v-model="form.gender">
                      <label for="male" class="w-25">Male</label>
                      <input id="female" type="radio" name="gender" class=" form-control text-left" value="Female"
                        style="width: 5% !important;" v-model="form.gender">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-primary">
                      <button class="btn btn-primary px-4" @click="saveChanges">Save Changes</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Please enter your password to terminate and delete your
              account. </h5>
          ...
          <div class="modal-body">
            <div class="input-group">
              <input type="password" class="form-control" placeholder="Enter your password"
                style="border: solid #D19C97" v-model="dltAccount.password" required>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" ata-dismiss="modal" @click="deleteAccount">Delete</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async saveChanges() {
      try {
        const response = await this.$axios.post("/admin/user/edit", this.form)
        this.editProfile()
        this.$notify({
          group: 'foo',
          title: 'Notification',
